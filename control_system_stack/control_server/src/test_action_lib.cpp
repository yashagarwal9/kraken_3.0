...
int main(int argc,char** argv)
{
    ...
    actionlib::SimpleActionClient<kraken_msgs::advancedControllerAction> ac("/kraken/control/advancedcontrol_action", true);
    actionlib::SimpleActionClient<kraken_msgs::controllerAction> ac1("/kraken/control/setpoint_action", true);
