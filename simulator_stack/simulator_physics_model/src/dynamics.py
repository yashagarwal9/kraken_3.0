...
#
    ...
    def pubTwist(self):
        ...
        twist.linear.x = self.v[0]
        twist.linear.y = self.v[1]
        twist.linear.z = self.v[2]

       	twist.angular.x = self.v[3]
        twist.angular.y = self.v[4]
        twist.angular.z = self.v[5]
    ...
    def __init__(self):
        ...
        self.output_twist_topic="/kraken/simulator/twist"
    ...
    #   Create publisher
        ...
        self.pub_twist = rospy.Publisher(self.output_twist_topic, Twist)
